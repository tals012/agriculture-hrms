...
// Status options for the history page
const statusOptions = [
  { value: "ALL", label: "הכל" },
...
export default function AttendanceHistoryFilter({ onFilterChange, initialFilters }) {
  const [filters, setFilters] = useState({
    ...
    approvalStatus: initialFilters?.approvalStatus 
      ? statusOptions.find(option => option.value === initialFilters.approvalStatus) 
      : statusOptions[0] // Default to "ALL"
  });
  ...
  const handleReset = () => {
    ...
    const resetFilters = {
      ...
      workerId: null,
      groupId: null,
      approvalStatus: statusOptions[0] // Reset to "ALL"
    };
  ...
  const handleApply = () => {
    ...
    const formattedFilters = {
      ...
      approvalStatus: filters.approvalStatus?.value
    };
    ...
    <div className={styles.filterSection}>
      <div className={styles.filterRow}>
        <div className={styles.filterHeader}>
          ...
          <h3 className={styles.title}>סינון היסטוריית דיווחי נוכחות</h3>
        </div>
        ...
        <div className={styles.filterControls}>
          ...
          <div className={styles.filterItem}>
            ...
            <ReactSelect
              ...
              onChange={(option) => handleFilterChange(option, 'approvalStatus')}
